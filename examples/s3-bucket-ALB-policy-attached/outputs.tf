output "PROJECT_NAME" {
  ...
  value = module.s3_bucket_alb_policy_attached.PROJECT_NAME
}
...
output "CONTENT_BUCKET" {
  ...
  value = module.s3_bucket_alb_policy_attached.CONTENT_BUCKET
}

output "BUCKET_ACL" {
  description = "The canned ACL to apply. Conflicts with 'grant'"
  value = module.s3_bucket_alb_policy_attached.BUCKET_ACL
}

output "ATTACH_LB_LOG_DELIVERY_POLICY" {
  description = "To control if S3 bucket should have ALB/NLB log delivery policy attached"
  value = module.s3_bucket_alb_policy_attached.ATTACH_LB_LOG_DELIVERY_POLICY
}

output "ATTACH_ELB_LOG_DELIVERY_POLICY" {
  description = "Versioning configuration Map"
  value = module.s3_bucket_alb_policy_attached.ATTACH_ELB_LOG_DELIVERY_POLICY
}

output "ATTACH_POLICY" {
  description = "Versioning configuration Map"
  value = module.s3_bucket_alb_policy_attached.ATTACH_POLICY
}